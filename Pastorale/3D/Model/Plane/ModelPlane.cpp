...
/// 初期化処理
/// </summary>
void ModelPlane::Initialize(Model* pModel) {
...
/// 描画処理
/// </summary>
void ModelPlane::Draw(Model* pModel, WorldTransform worldTransform, Matrix4x4& viewMatrix) {
...
/// コマンドコール処理
/// </summary>
void ModelPlane::CommandCall(uint32_t texture) {
